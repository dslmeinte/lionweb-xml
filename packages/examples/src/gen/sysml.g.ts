...
export class sysmlBase implements ILanguageBase {
    ...
    private ensureWiredUp() {
        ...
        this._language.havingEntities(this._SelectExpression, this._OperatorExpression, this._InvocationExpression, this._InstantiationExpression, this._Expression, this._Step, this._Feature, this._Type, this._Namespace, this._Element, this._OwningMembership, this._Membership, this._Relationship, this._VisibilityKind, this._Documentation, this._Comment, this._AnnotatingElement, this._Annotation, this._TextualRepresentation, this._Import, this._Specialization, this._FeatureMembership, this._Conjugation, this._Multiplicity, this._Intersecting, this._Unioning, this._Disjoining, this._Differencing, this._FeatureDirectionKind, this._Redefinition, this._Subsetting, this._FeatureTyping, this._TypeFeaturing, this._FeatureInverting, this._FeatureChaining, this._ReferenceSubsetting, this._CrossSubsetting, this._Behavior, this._Class, this._Classifier, this._Subclassification, this._Function, this._ConstructorExpression, this._NullExpression, this._IndexExpression, this._CollectExpression, this._LiteralBoolean, this._LiteralExpression, this._FeatureReferenceExpression, this._MetadataAccessExpression, this._MetadataFeature, this._Metaclass, this._Structure, this._LiteralRational, this._LiteralInteger, this._LiteralString, this._FeatureChainExpression, this._LiteralInfinity, this._BooleanExpression, this._Predicate, this._ReturnParameterMembership, this._ParameterMembership, this._Invariant, this._ResultExpressionMembership, this._MultiplicityRange, this._FeatureValue, this._DataType, this._BindingConnector, this._Connector, this._Association, this._Succession, this._AssociationStructure, this._Package, this._LibraryPackage, this._ElementFilterMembership, this._Flow, this._FlowEnd, this._PayloadFeature, this._Interaction, this._SuccessionFlow, this._EndFeatureMembership, this._MembershipImport, this._NamespaceImport, this._Dependency, this._VerificationCaseUsage, this._CaseUsage, this._CalculationUsage, this._ActionUsage, this._OccurrenceUsage, this._Usage, this._VariantMembership, this._Definition, this._ReferenceUsage, this._AttributeUsage, this._EnumerationUsage, this._EnumerationDefinition, this._AttributeDefinition, this._ItemUsage, this._PartUsage, this._PartDefinition, this._ItemDefinition, this._OccurrenceDefinition, this._PortUsage, this._PortDefinition, this._ConjugatedPortDefinition, this._PortConjugation, this._ConnectorAsUsage, this._FlowUsage, this._InterfaceUsage, this._ConnectionUsage, this._InterfaceDefinition, this._ConnectionDefinition, this._AllocationUsage, this._AllocationDefinition, this._StateUsage, this._TransitionUsage, this._AcceptActionUsage, this._ConstraintUsage, this._RequirementUsage, this._RequirementDefinition, this._ConstraintDefinition, this._ConcernUsage, this._ConcernDefinition, this._AnalysisCaseUsage, this._AnalysisCaseDefinition, this._CaseDefinition, this._CalculationDefinition, this._ActionDefinition, this._UseCaseUsage, this._UseCaseDefinition, this._ViewUsage, this._ViewDefinition, this._ViewpointUsage, this._ViewpointDefinition, this._RenderingUsage, this._RenderingDefinition, this._MetadataUsage, this._PortionKind, this._VerificationCaseDefinition, this._RequirementVerificationMembership, this._RequirementConstraintMembership, this._RequirementConstraintKind, this._MetadataDefinition, this._EventOccurrenceUsage, this._AssignmentActionUsage, this._TriggerInvocationExpression, this._TriggerKind, this._SendActionUsage, this._WhileLoopActionUsage, this._LoopActionUsage, this._PerformActionUsage, this._ForLoopActionUsage, this._TerminateActionUsage, this._DecisionNode, this._ControlNode, this._IfActionUsage, this._MergeNode, this._JoinNode, this._ForkNode, this._StateSubactionMembership, this._StateSubactionKind, this._TransitionFeatureKind, this._TransitionFeatureMembership, this._StateDefinition, this._ExhibitStateUsage, this._ObjectiveMembership, this._ActorMembership, this._SubjectMembership, this._StakeholderMembership, this._FramedConcernMembership, this._SatisfyRequirementUsage, this._AssertConstraintUsage, this._MembershipExpose, this._Expose, this._NamespaceExpose, this._ViewRenderingMembership, this._BindingConnectorAsUsage, this._SuccessionAsUsage, this._ConjugatedPortTyping, this._SuccessionFlowUsage, this._FlowDefinition, this._IncludeUseCaseUsage);
